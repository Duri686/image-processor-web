...
import { Download, Trash2, CheckCircle2, Clock, Loader2, ImageIcon } from 'lucide-react';
...
export const ImageList: React.FC<ImageListProps> = memo(
  ({ images, isProcessing, processingProgress, onDownload, onDownloadAllCompleted, onClearAll }) => {
  ...
  const getImageStatus = (image: ImageFile) => {
    ...
    if (isProcessing && processingProgress && processingProgress.fileName === image.file.name) return 'processing'
    return 'queued'
  }
        ...
        {images.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center py-16">
            ...
            <p className="text-gray-600 max-w-sm">
              Upload your images to start converting them to your preferred format with optimized quality.
            </p>
          </div>
        ) : (
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                          ...
                          <div className="text-sm text-gray-600 font-medium">
                            ...
                            {image.processedImage && image.processedImage.blob && (
                              <>
                                <span className="text-gray-400 mx-2">→</span>
                                {formatBytes(image.processedImage.blob.size)}
                                {(() => {
